namespace Scopes.Engine.Tests.Crossover
{
    ...
    public class OnePointCrossoverTests
    {
        ...
        public void Crossover()
        {
            ...
            var father = new Chromosome(4, 1, 2, FunctionSet, fNodes) { LinkingFunction = new AdditionNode() };
            var mother = new Chromosome(4, 1, 2, FunctionSet, mNodes) { LinkingFunction = new AdditionNode() };
