namespace Scopes.Engine.Tests.Nodes
{
    ...
    public class SubtractionNodeTests
    {
        ...
        {
            Assert.DoesNotThrow(() => new SubtractionNode(new ConstantNode(5.0), new ConstantNode(5.0)));
        }

        [Test, ExpectedException(typeof(ArgumentNullException))]
        public void ConstructorNullLeft()
        {
            new SubtractionNode(null, new ConstantNode(5.0));
        }

        [Test, ExpectedException(typeof(ArgumentNullException))]
        public void ConstructorNullRight()
        {
            new SubtractionNode(new ConstantNode(5.0), null);
        }

        [Test]
        public void GetArity()
        {
            var node = new SubtractionNode(new ConstantNode(5.0), new ConstantNode(5.0));
        ...
        public void GetChildren()
        {
            ...
            var node = new SubtractionNode(left, right);
